...
public class GUIDemo extends JFrame
{
    ...
    private JButton titleChangingButton;
    ...
    public GUIDemo()
    {
        ...
        titleChangingButton = new JButton("NEW TITLE");
        biggerButton.addActionListener(new ButtonHandler());
        smallerButton.addActionListener(new ButtonHandler());
        titleChangingButton.addActionListener(new ButtonHandler());
        add(panel);
        panel.add(biggerButton);
        panel.add(smallerButton);
        panel.add(titleChangingButton);
        setVisible(true);
    }
